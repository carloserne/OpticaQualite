let compras = [];
let cuerpotblCompras;
let lineaCompra;
let date = new Date;
let fecha;
let posGlobal;

fetch("Modulos/moduloCompras/data_Compras.json")
    .then(response => {
...
export function cargarComprasTbl() {
    let cuerpotblCompras;
    compras.forEach(function (compra) {
        let lineaCompra =
            ...
            '<td>' + compra.precio + '</td>' +
            '<td>' + compra.cantidad + '</td></tr>';
            cuerpotblCompras += lineaCompra;
    });
    document.getElementById("tblCompras").innerHTML = cuerpotblCompras;
    cuerpotblCompras = "";
}

export function registrar() {
    fetch("./Modulos/moduloCompras/view_RegistrarCompra.html")
...
export function eliminar() {
    fetch("./Modulos/moduloPagos/view_eliminarPagos.html")
        ...
        .then(function (html) {
            document.getElementById("contenedorGestion").innerHTML = html;
            import("./controller_Bitacora.js").then(
                function (controller) {
...
export function catalogo() {
    fetch("./Modulos/moduloCompras/view_bitacoraCompras.html")
        .then(function (respuesta) {
            return respuesta.text();
        })
        .then(function (html) {
